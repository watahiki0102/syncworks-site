...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'キャンセル料は業者によって異なります。一般的に引越し予定日の3日前までのキャンセルは無料、前日・当日のキャンセルには料金が発生する場合があります。'
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answer: 'エアコンの取り外し・取り付けは別途オプション料金がかかる場合があります。専門技術が必要なため、対応可能な業者にご相談ください。'
  },
  {
    id: 7,
    question: '荷物の破損が心配です。保険はありますか？',
    answer: 'ほとんどの引越し業者は運送保険に加入しており、万が一の荷物破損に対して補償があります。詳細な補償内容は業者にご確認ください。'
  },
  {
    id: 8,
